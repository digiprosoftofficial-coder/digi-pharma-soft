...
use App\Http\Controllers\Tenant\PackageTemplateController;
...
use App\Http\Controllers\Tenant\Reports\BranchReportController;
use App\Http\Controllers\Tenant\Reports\CustomerReportController;
use App\Http\Controllers\Tenant\Reports\DueReportController;
use App\Http\Controllers\Tenant\Reports\ExpiryReportController;
use App\Http\Controllers\Tenant\Reports\FinancialReportController;
...
use App\Http\Controllers\Tenant\Reports\SupplierReportController;
use App\Http\Controllers\Tenant\Reports\UserActivityReportController;
...
Route::middleware(['auth', 'verified', 'tenant.subscription'])->group(function () {
    Route::middleware(['tenant.staff'])->group(function () {
        Route::name('tenant.')->group(function () {
            ...
            Route::post('/sales/package', [PackageSaleController::class, 'store'])->name('sales.package.store');
            Route::get('/sales/packages', [PackageTemplateController::class, 'index'])->name('sales.packages.index');
            Route::get('/sales/packages/create', [PackageTemplateController::class, 'create'])->name('sales.packages.create');
            Route::post('/sales/packages', [PackageTemplateController::class, 'store'])->name('sales.packages.store');
            Route::get('/sales/packages/{packageTemplate}/edit', [PackageTemplateController::class, 'edit'])->name('sales.packages.edit');
            Route::put('/sales/packages/{packageTemplate}', [PackageTemplateController::class, 'update'])->name('sales.packages.update');
            Route::delete('/sales/packages/{packageTemplate}', [PackageTemplateController::class, 'destroy'])->name('sales.packages.destroy');
            ...
            Route::get('/reports/expiry', [ExpiryReportController::class, 'index'])->name('reports.expiry');
            Route::get('/reports/expiry/export', [ExpiryReportController::class, 'export'])->name('reports.expiry.export');
            Route::get('/reports/suppliers', [SupplierReportController::class, 'index'])->name('reports.suppliers');
            Route::get('/reports/suppliers/export', [SupplierReportController::class, 'export'])->name('reports.suppliers.export');
            ...
            Route::get('/reports/finance/export', [FinancialReportController::class, 'export'])->name('reports.finance.export');
            Route::get('/reports/branches', [BranchReportController::class, 'index'])->name('reports.branches');
            Route::get('/reports/branches/export', [BranchReportController::class, 'export'])->name('reports.branches.export');
            Route::get('/reports/user-activity', [UserActivityReportController::class, 'index'])->name('reports.user-activity');
            Route::get('/reports/user-activity/export', [UserActivityReportController::class, 'export'])->name('reports.user-activity.export');
