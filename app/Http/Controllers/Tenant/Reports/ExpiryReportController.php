...
final class ExpiryReportController extends Controller
{
    public function __construct(
        private readonly ExpiryReportService $reports,
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Reports/ExpiryManagement', [
    ...
    public function export(Request $request): Response
    {
        ...
        return $this->output->respond(
            ...
            ['Product', 'SKU', 'Batch', 'Branch', 'Location', 'Quantity', 'Expiry', 'Status'],
