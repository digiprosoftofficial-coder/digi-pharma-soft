...
final class TenantPresenter
{
    ...
    public static function detail(Tenant $tenant): array
    {
        return [
            ...
            'supplier_branch_ledger_override' => TenantFeatures::supplierBranchLedgerOverrideMode($tenant),
            'supplier_branch_ledger_enabled' => TenantFeatures::supplierBranchLedgerEnabled($tenant),
            'plan_supplier_branch_ledger' => TenantFeatures::fromPlan($tenant, TenantFeatures::SUPPLIER_BRANCH_LEDGER),
            'employee_management_override' => TenantFeatures::employeeManagementOverrideMode($tenant),
            'employee_management_enabled' => TenantFeatures::employeeManagementEnabled($tenant),
            'plan_employee_management' => TenantFeatures::fromPlan($tenant, TenantFeatures::EMPLOYEE_MANAGEMENT, true),
            'attendance_override' => TenantFeatures::attendanceOverrideMode($tenant),
            'attendance_enabled' => TenantFeatures::attendanceEnabled($tenant),
            'plan_attendance' => TenantFeatures::fromPlan($tenant, TenantFeatures::ATTENDANCE),
            'hr_payroll_override' => TenantFeatures::hrPayrollOverrideMode($tenant),
            'hr_payroll_enabled' => TenantFeatures::hrPayrollEnabled($tenant),
            'plan_hr_payroll' => TenantFeatures::fromPlan($tenant, TenantFeatures::HR_PAYROLL),
