...
const sectionsConfig = computed(() => [
    ...
    },
    {
        ...
        show: can('products.view') || can('categories.view') || can('product_types.view') || can('manufacturers.view'),
        paths: ['/products', '/categories', '/product-types', '/manufacturers', '/catalog/import'],
        children: [
